...
setup(name=NAME,
      ...
      author='Manuel Bolzoni',
      author_email='manuel.bolzoni@retelit.it',
      url='https://github.com/manuelbolzoni/SMHstamon',
      download_url='https://github.com/manuelbolzoni/SMHstamon/releases',
